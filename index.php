                        ...
                        if ($total > 1) {
                            echo '
                                <nav class="mt-5">
                                    <ul class="pagination">
                                    ';
                            echo        $pstr_prev.$page5left.$page4left.$page3left.$page2left.$page1left."<li class='page-item'><a class='pstr-active page-link' href='view_cat.php?'.$catlink.'type='.$type.'page=".$page."'>".$page."</a></li>".$page1right.$page2right.$page3right.$page4right.$page5right.$strtotal.$pstr_next;
                            echo '
                                    </ul>
                                </nav>
                                ';
